...
from shapelearningtheory.datasets import make_LT_texture
from shapelearningtheory.datasets import LTDataModule
from shapelearningtheory.colors import RandomGrey
...
# Load dataset
print("Loading data")
traindata = make_LT_texture()
traindata.prepare_data()
eval_data = LTDataModule(
    imgheight=18, imgwidth=18, 
    heights=range(7, 13, 2), widths=range(7, 13, 3),
...
feature_jacobians = get_jacobians_per_layer(texture_net, eval_data_loader)
...
os.makedirs("figures/experiment_4d", exist_ok=True)
fig = make_violinplot(consistencies)
fig.savefig("figures/experiment_4d/gradient_sparsity.png", bbox_inches="tight")
fig = plot_mean_consistencies(consistencies)
fig.savefig("figures/experiment_4d/gradient_consistency_imgs.png", bbox_inches="tight")
...
consistencies = compare_all_consistencies(net_jacobians, feature_jacobians)
fig = make_violinplot(consistencies)
fig.savefig("figures/experiment_4d/gradient_sparsity_epoch1.png", bbox_inches="tight")
fig = plot_mean_consistencies(consistencies)
fig.savefig("figures/experiment_4d/gradient_consistency_imgs_epoch1.png", bbox_inches="tight")
del net_jacobians, feature_jacobians, consistencies
...
consistencies = compare_all_consistencies(net_jacobians, feature_jacobians)
fig = make_violinplot(consistencies)
fig.savefig("figures/experiment_4d/gradient_sparsity_epoch10.png", bbox_inches="tight")
fig = plot_mean_consistencies(consistencies)
fig.savefig("figures/experiment_4d/gradient_consistency_imgs_epoch10.png", bbox_inches="tight")