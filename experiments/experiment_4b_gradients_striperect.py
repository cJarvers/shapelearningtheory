...
from shapelearningtheory.datasets import make_rectangles_texture
...
os.makedirs("figures/experiment_4b", exist_ok=True)
fig = make_violinplot(consistencies)
fig.savefig("figures/experiment_4b/gradient_sparsity.png", bbox_inches="tight")
fig = plot_mean_consistencies(consistencies)
fig.savefig("figures/experiment_4b/gradient_consistency_imgs.png", bbox_inches="tight")
...
consistencies = compare_all_consistencies(net_jacobians, feature_jacobians)
fig = make_violinplot(consistencies)
fig.savefig("figures/experiment_4b/gradient_sparsity_epoch1.png", bbox_inches="tight")
fig = plot_mean_consistencies(consistencies)
fig.savefig("figures/experiment_4b/gradient_consistency_imgs_epoch1.png", bbox_inches="tight")
del net_jacobians, feature_jacobians, consistencies
...
consistencies = compare_all_consistencies(net_jacobians, feature_jacobians)
fig = make_violinplot(consistencies)
fig.savefig("figures/experiment_4b/gradient_sparsity_epoch10.png", bbox_inches="tight")
fig = plot_mean_consistencies(consistencies)
fig.savefig("figures/experiment_4b/gradient_consistency_imgs_epoch10.png", bbox_inches="tight")