...
from shapelearningtheory.networks import make_convnet_small, TextureConvNet, LTConvNet

# Load dataset
traindata = make_dataset("LvT", "stripes", "small", "standard")
traindata.prepare_data()
testdata = make_dataset("LvT", "stripes", "small", "random")
